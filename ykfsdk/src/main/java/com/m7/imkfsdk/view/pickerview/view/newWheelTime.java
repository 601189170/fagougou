...
public class newWheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        // 年
        wv_year = (newWheelView) view.findViewById(R.id.year);
        ...
        // 月
        wv_month = (newWheelView) view.findViewById(R.id.month);
        ...
        // 日
        wv_day = (newWheelView) view.findViewById(R.id.day);
