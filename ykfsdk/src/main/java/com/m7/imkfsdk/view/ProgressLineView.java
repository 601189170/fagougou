...
public class ProgressLineView extends View {
    ...
    private int PAINTSTROKEWIDTH = DensityUtil.dp2px(1f);
    private int STARTX = DensityUtil.dp2px(15f);
    private int TOPLINELENGTH = DensityUtil.dp2px(15f);
    private int RADIUS = DensityUtil.dp2px(4f);
