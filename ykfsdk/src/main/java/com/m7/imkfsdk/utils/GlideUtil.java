...
public class GlideUtil {
    ...
    public static void loadHeader(Context context, String imgUrl, int placeholder, int error, ImageView imageView) {
        Glide.with(context)
                ...
                .error(error)
                .apply(RequestOptions.bitmapTransform(new RoundedCorners(DensityUtil.dp2px(8f))))
                .into(imageView);

    }

    public static void loadImageNoRounder(Context context, String imgUrl, ImageView imageView) {
        Glide.with(context)
                .load(imgUrl)
    ...
    public static void loadImage(Context context, String imgUrl, float rounder, ImageView imageView) {
        Glide.with(context)
                ...
                .placeholder(R.drawable.ykfsdk_kf_pic_thumb_bg)
                .error(R.drawable.ykfsdk_image_download_fail_icon)
                .apply(RequestOptions.bitmapTransform(new RoundedCorners(DensityUtil.dp2px(rounder))))
                .into(imageView);
    }
