...
public class ChatAdapter extends BaseAdapter {
    ...
    void initRowItems() {
        ...
        chatRowHashMap.put(3, new ImageRxChatRow(3));//收到的图片消息
        chatRowHashMap.put(4, new ImageTxChatRow(4));//发出的图片消息
        chatRowHashMap.put(5, new VoiceRxChatRow(5));//收到语音消息
        chatRowHashMap.put(6, new VoiceTxChatRow(6));//发送的语音消息
        chatRowHashMap.put(7, new InvestigateChatRow(7));//评价类型消息
        chatRowHashMap.put(8, new FileRxChatRow(8));//收到的文件消息
        chatRowHashMap.put(9, new FileTxChatRow(9));//发送的文件消息
        ...
        chatRowHashMap.put(26, new XbotFormRxChatRow(26));//收到的xbot表单消息类型
        chatRowHashMap.put(27, new XbotFormSubmitTxChatRow(27));//发出的xbot表单消息类型
        chatRowHashMap.put(28, new QuickMenuListRxRow(28));//Xbot 快捷菜单按钮 横向滑动
