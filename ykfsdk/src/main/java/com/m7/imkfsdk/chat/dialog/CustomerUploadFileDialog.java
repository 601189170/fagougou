...
public class CustomerUploadFileDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        tv_fileName = (TextView) uploadView.findViewById(R.id.erp_field_file_upload_tv_filename);
        tv_fileSize = (TextView) uploadView.findViewById(R.id.erp_field_file_upload_tv_filesize);
        tv_precent = (TextView) uploadView.findViewById(R.id.erp_field_file_upload_tv_precent);
        progressBar = (ProgressBar) uploadView.findViewById(R.id.erp_field_file_upload_pb);
    ...
    private void sendFile(final String filePath, final String fileName) {
        IMChat.getInstance().upLoadXbotFromFile(filePath, fileSizeStr, new IMChat.onXbotFormUpFileListener() {
            @Override
            public void onisOK(String netfilepath) {
                if (listener != null) {
