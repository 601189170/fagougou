        ...
        if (detail != null) {
            if(!TextUtils.isEmpty(detail.common_questions_group)){
                ...
                if(!TextUtils.isEmpty(detail.common_questions_img)) {
                    Glide.with(context)
                            .load(detail.common_questions_img)
                            .placeholder(R.drawable.ykfsdk_ic_kf_tabquestion)
                            .error(R.drawable.ykfsdk_ic_kf_tabquestion)
                            .into(holder.getIv_tab_question_logo());
                }else{
